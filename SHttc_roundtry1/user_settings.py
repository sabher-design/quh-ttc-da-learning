...
class Constants(BaseConstants):
   ...
   # print(f"student_valuations: {student_valuations}")
    ...
    valuations_rounds = {
        1: {'Type 1': [13, 8, 18, 3], 'Type 2': [18, 13, 3, 8], 'Type 3': [13, 8, 3, 18], 'Type 4': [13, 8, 18, 3]},
        2: {'Type 1': [18, 13, 8, 3], 'Type 2': [18, 13, 3, 8], 'Type 3': [18, 8, 13, 3], 'Type 4': [13, 18, 8, 3]},
        3: {'Type 1': [3, 8, 18, 13], 'Type 2': [3, 8, 13, 18], 'Type 3': [3, 8, 13, 18], 'Type 4': [8, 13, 18, 3]}
    }
   ...
   # ...
    ...
    priorities_rounds = {
        1: {'priorities_r1': [2, 1, 3, 4], 'priorities_r2': [2, 1, 3, 4], 'priorities_r3': [2, 1, 3, 4], 'priorities_r4': [2, 1, 3, 4]},
        2: {'priorities_r1': [1, 2, 3, 4], 'priorities_r2': [1, 2, 3, 4], 'priorities_r3': [1, 2, 3, 4], 'priorities_r4': [1, 2, 3, 4]},
        3: {'priorities_r1': [3, 1, 4, 2], 'priorities_r2': [3, 1, 4, 2], 'priorities_r3': [3, 1, 4, 2], 'priorities_r4': [3, 1, 4, 2]}
    }
    ...
    nr_types = len(valuations_rounds[1]['Type 1'])
    #print(f"nr_types: {nr_types}")
