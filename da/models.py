...
class Subsession(BaseSubsession):
    ...
    def creating_session(self):
        ...
        for p in players:
            ...
            p.participant.vars['player_prefs'] = [None for _ in indices]
            p.participant.vars['successful'] = [False for _ in indices]
...
class Group(BaseGroup):
    ...
    def get_allocation(self):
        ...
        attendants = [[] for _ in indices]
        player_resource = [[] for _ in players]
