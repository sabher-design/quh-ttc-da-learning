...
class Group(BaseGroup):
    ...
    def get_allocation(self):
        ...
        while size_counter <= len(players_in_round) - 1:
            ...
            ## can i use something like: if group_index==1 use:.. if group_index==2 use:...
            top_priorities_in_round = []
            print(f"priorities left second time: {priorities_left}")
            ...
            if cycles_found:
                ...
                for i in cycles_found:
                    for j in priorities_left:
                        j.remove(i[0][0])
                        print(f"priorities left third time: {priorities_left}")
