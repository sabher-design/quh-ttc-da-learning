...
def vars_for_all_templates(self):
    return {
        ...
        'valuations1': self.participant.vars['valuations1'],
        'valuations1_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['valuations1_others']),
        'priorities1': self.participant.vars['priorities1'],
